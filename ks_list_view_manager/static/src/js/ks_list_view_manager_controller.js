odoo.define('ks_list_view_manager.controller', function (require) {
    ...
    var bill = bill_data.prototype.config.Controller.extend(_.extend({}, ListController.prototype, {

        buttons_template: 'BillsListView.buttons',
        events: _.extend({}, ListController.prototype.events, bill_data.prototype.config.Controller.prototype.events),
    }, {}));

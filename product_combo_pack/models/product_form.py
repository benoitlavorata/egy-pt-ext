...
class ProductPack(models.Model):
    ...
    is_pack = fields.Boolean(_('Is a Pack'))
    pack_price = fields.Integer(string=_("Pack Price"), compute='set_pack_price', store=True)
    pack_products_ids = fields.One2many('pack.products', 'product_tmpl_id', string=_('Pack Products'))
    pack_quantity = fields.Integer(_('Pack Quantity'))

odoo.define('map_view.MapView', function (require) {
    "use strict";

    var MapModel = require('map_view.MapModel');
    var MapController = require('map_view.MapController');
    var MapRenderer = require('map_view.MapRenderer');
    ...
    var MapView = AbstractView.extend({
        jsLibs: [
            '/map_view/static/lib/leaflet/leaflet.js',
        ],

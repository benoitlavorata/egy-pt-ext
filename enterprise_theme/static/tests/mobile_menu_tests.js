odoo.define('enterprise_theme.mobile_menu_tests', function (require) {
"use strict";

var Menu = require('enterprise_theme.Menu');
var testUtils = require('web.test_utils');
var testUtilsEnterprise = require('enterprise_theme.test_utils');
var UserMenu = require('web.UserMenu');

QUnit.module('enterprise_theme mobile_menu_tests', {
    afterEach() {

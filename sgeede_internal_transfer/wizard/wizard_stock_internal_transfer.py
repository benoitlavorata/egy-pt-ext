...
class wizard_stock_internal_transfer(models.TransientModel):
    ...
    transfer_id = fields.Many2one('stock.internal.transfer', string=_("Transfer"))
    item_ids = fields.One2many('stock.internal.transfer.items', 'transfer_id', string=_("Items"))

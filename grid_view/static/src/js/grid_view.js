odoo.define('grid_view.GridView', function (require) {
"use strict";

var AbstractView = require('web.AbstractView');
var config = require('web.config');
var core = require('web.core');
var GridModel = require('grid_view.GridModel');
var GridController = require('grid_view.GridController');
var GridRenderer = require('grid_view.GridRenderer');

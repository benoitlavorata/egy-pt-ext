odoo.define('mail_new.systray.MessagingMenu', function (require) {
...
const SwipeItemMixin = require('enterprise_theme.SwipeItemMixin');
const SnackBar = require('enterprise_theme.SnackBar');
